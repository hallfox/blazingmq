...
// mwcio_decoratingchannelpartialimp.h                                -*-C++-*-
#ifndef INCLUDED_MWCIO_DECORATINGCHANNELPARTIALIMP
#define INCLUDED_MWCIO_DECORATINGCHANNELPARTIALIMP

//@PURPOSE: Provide a partial imp of 'mwcio::Channel' for decorating channels
//
//@CLASSES:
// mwcio::DecoratingChannelPartialImp
//
//@SEE_ALSO:
//
//@DESCRIPTION: This component defines a partial implementation,
// 'mwcio::DecoratingChannelPartialImp', of the 'mwcio::Channel' protocol for
// 'mwcio::Channel' implementations that decorate an underlying
// 'mwcio::Channel'.  It mostly handles forwarding the most logical methods to
// the underlying 'mwcio::Channel'.
...
inline mwct::PropertyBag& DecoratingChannelPartialImp::properties()
{
