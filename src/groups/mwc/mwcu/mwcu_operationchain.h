...
// mwcu_operationchain.h                                              -*-C++-*-
#ifndef INCLUDED_MWCU_OPERATIONCHAIN
#define INCLUDED_MWCU_OPERATIONCHAIN
...
//
//@DESCRIPTION:
// This component provides a mechanism, 'mwcu::OperationChain', to serialize
...
/// Operations
///----------
// An asynchronous operation submitted to 'mwcu::OperationChain' is represented
...
/// Links
///-----
// A link in the operation chain is represented by 'mwcu::OperationChainLink',
...
/// Thread safety
///-------------
//: o 'mwcu::OperationChain' is fully thread-safe.
//: o 'mwcu::OperationChainLink' is not thread-safe.
//
/// Usage
///-----
