...
#include <mwcex_bindutil_cpp03.h>      // Pro-forma #include

// Empty file except when compiling mwcex_bindutil.cpp
#ifdef COMPILING_MWCEX_BINDUTIL_CPP
