...
#include <mwcex_promise_cpp03.h>      // Pro-forma #include

// Empty file except when compiling mwcex_promise.cpp
#ifdef COMPILING_MWCEX_PROMISE_CPP
