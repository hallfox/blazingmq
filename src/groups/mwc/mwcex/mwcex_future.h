...
// mwcex_future.h                                                     -*-C++-*-
#ifndef INCLUDED_MWCEX_FUTURE
#define INCLUDED_MWCEX_FUTURE

//@PURPOSE: Provides a mechanism to access the result of an async operation.
//
//@CLASSES:
//  mwcex::Future:            an async result provider
//  mwcex::FutureStatus:      codes returned by public API
//  mwcex::FutureResult:      an established async result provider
//  mwcex::FutureSharedState: a shared state
//
//@SEE ALSO:
//  mwcex_promise
//
//@DESCRIPTION:
// This component provides a mechanism, 'mwcex::Future', to access the result
// of an asynchronous operation. In addition the generalized 'mwcex::Future<R>'
// class template two specializations, 'mwcex::Future<void>', and
// 'mwcex::Future<R&>' are provided.
//
// This component also provides a mechanism, 'mwcex::FutureResult', to access
...
// examples below). In addition the generalized 'mwcex::FutureResult<R>' class
// template two specializations, 'mwcex::FutureResult<void>', and
// 'mwcex::FutureResult<R&>' are provided.
//
// Behind a 'mwcex::Future' or 'mwcex::FutureResult' lies an
// 'mwcex::FutureSharedState' object called the shared state. The shared state
...
// provider is 'mwcex::Promise'). Result providers do create a shared state and
...
// function, 'mwcex::Future' is thread-safe, meaning that multiple threads may
// use their own instances of the class or use a shared instance without
// further synchronization.
//
// With the exception of assignment operators, as well as the 'swap' member
// function, 'mwcex::FutureResult' is thread-safe, meaning that multiple
// threads may use their own instances of the class or use a shared instance
// without further synchronization.
//
// 'mwcex::FutureSharedState' is fully thread-safe, meaning that multiple
// threads may use their own instances of the class or use a shared instance
...
// provider, such as 'mwcex::Promise'.
//..
...
// 'mwcex::FutureResult<R>', where 'R' is the type of the result. Objects of
