...
// mwcex_bindutil.h                                                   -*-C++-*-
#ifndef INCLUDED_MWCEX_BINDUTIL
#define INCLUDED_MWCEX_BINDUTIL
...
//
//@DESCRIPTION:
// This component provides a struct, 'mwcex::BindUtil', that serves as a
...
// function (i.e. 'mwcex::ExecutionUtil::execute') directly into the
...
// execution function (i.e. 'mwcex::ExecutionUtil::execute') directly into the
// notification callback.
//..
//  // subscribe to notifications
//  g_observable_p->subscribe(mwcex::BindUtil::bindExecute(
//                                 mwcex::ExecutionPolicyUtil::oneWay()
//                                                            .neverBlocking(),
//                                 &processEvent));
//..
